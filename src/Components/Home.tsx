  ...
  return (
    <div className={`overflow-x-hidden ${toggle === null ? "" : toggle ? "contract" : "expand"}`}>
      ...
      {/* CONTENT SECTION */}
        ...
        <div className="bg-[#111722] font-stylish">
      ...
      <div className="flex justify-center">
        <Link
          to="/how-it-works"
          className="flex justify-center fontstylish py-2 hover:bg-slate-200 rounded-sm text-[16px] text-slate-800 border-black border-[1px] m-2 w-[600px]"
        >
      ...
      {/* CONTACT */}
      <div className="text-[45px] flex justify-center mt-20 mb-5">Contact Us</div>
